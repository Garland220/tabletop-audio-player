(function() {
  ...
  var tracks = [
    ...
    {url: 'audio/sound/sitcom_laugh.ogg', key: 'sitcomLaugh', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/badumtss.ogg', key: 'badumtss', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    ...
    {url: 'audio/sound/retard_alert.ogg', key: 'retardAlert', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    ...
    {url: 'audio/sound/ff7_good_night.ogg', key: 'ff7Goodnight', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/ff7_victory.ogg', key: 'ff7Victory', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/ff5_victory.ogg', key: 'ff5Victory', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/zelda_chest.ogg', key: 'zeldaChest', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/zelda_item.ogg', key: 'zeldaItem', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/zelda_secret.ogg', key: 'zeldaSecret', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    {url: 'audio/sound/metalgear_spotted.ogg', key: 'metalgearSpotted', type: 'sound', category: 'fun', volume: 1.0, loop: false},
    ...
    {url: 'audio/sound/pour_drink.ogg', key: 'pourDrink', type: 'sound', category: 'civilization', preload: 'none', volume: 0.7, loop: false},
    {url: 'audio/sound/serving_stew.ogg', key: 'serveStew', type: 'sound', category: 'civilization', preload: 'none', volume: 0.7, loop: false},
